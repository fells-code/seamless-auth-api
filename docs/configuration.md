...
| `authenticator_policy`           | object               | `AUTHENTICATOR_POLICY`           | `{attachment:"any",userVerification:"required",attestation:"none",requireKnownAuthenticator:false,syncedPasskeys:"block",aaguidAllowList:[],aaguidDenyList:[]}` |
